package tugas.davit.jumlahbilangan;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUI() {
        bil1 = (EditText) findViewById(R.id.editTextNumber2);
        bil2 = (EditText) findViewById(R.id.editTextNumber3);
        jumlah = (EditText) findViewById(R.id.editTextNumber);
